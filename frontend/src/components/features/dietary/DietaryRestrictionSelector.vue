<template>
    <div class="flex flex-wrap gap-2">
        <DietaryRestrictionCard
            ...
            :item-size="itemSize"
            :selected="selectedList && selectedList.includes(option.name)"
        ...
        >
            ...
            />
            <span class="text-gray-700 text-sm capitalize">{{ option }}</span> -->
        </DietaryRestrictionCard>
    </div>
</template>
...
const dietaryOptions = [
    ...
    { name: 'Gluten-Free', iconURL: "/src/assets/wheat-barley-svgrepo-com-free.svg" },
    { name: 'Dairy-Free', iconURL: "/src/assets/milk-svgrepo-com-free.svg" },
    { name: 'Nut-Free', iconURL: "/src/assets/nut-hazelnut-svgrepo-com-free.svg" },
];
